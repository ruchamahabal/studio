...
def ai_setup_state():
	...
	providers = frappe.get_all("Studio AI Provider", filters={"enabled": 1}, fields=["name", "api_key"])
	settings_key = frappe.get_single("Studio Settings").get_password("ai_api_key", raise_exception=False)
