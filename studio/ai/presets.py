...
PRESETS = [
	{
		...
		"models": [
			("anthropic/claude-sonnet-4-6", "Claude Sonnet 4.6", "Best all-rounder for building apps", True),
			("openai/gpt-5-mini", "GPT-5 Mini", "Fastest and cheapest of the good ones", True),
			("google/gemini-3.1-pro-preview", "Gemini 3.1 Pro", "Strongest Gemini", False),
			("google/gemini-3-flash-preview", "Gemini 3 Flash", "Google's latest, fast", False),
			("moonshotai/kimi-k2.6", "Kimi K2.6", "Strong open-weights option", False),
		],
	},
	{
		"id": "anthropic",
		...
		"models": [
			("claude-sonnet-4-6", "Claude Sonnet 4.6", "Best all-rounder for building apps", True),
			("claude-haiku-4-6", "Claude Haiku 4.6", "Fastest and cheapest Claude", False),
		],
	},
	{
		"id": "openai",
		...
		"models": [
			("gpt-5-mini", "GPT-5 Mini", "Fast and cheap", True),
			("gpt-5", "GPT-5", "Frontier tier from OpenAI", False),
		],
	},
	{
		"id": "codex",
	...
	},
	{
		...
		"models": [
			("gemini-3-flash-preview", "Gemini 3 Flash", "Latest, fast, good value", True),
